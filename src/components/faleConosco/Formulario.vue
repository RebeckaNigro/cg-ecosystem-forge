<template>
  <form
    action="submit"
    class="fale-conosco container px-5 pb-5 box d-flex flex-wrap justify-content-between"
  >
    <!-- NOME-->
    <div class="row w-100">
      <div class="col-12">
    ...
    <div class="row w-100">
      <div class="col">
        <button type="button" class="col green-btn-outlined" @click="$router.back()">VOLTAR</button>
      </div>
