<template>
	...
	<form @submit.prevent="cadastrar" class="container box p-5 my-5">
		<div class="mb-3">
			<label for="nome-completo" class="form-label-primary">Nome Completo*</label>
			<input type="text" id="nome-completo" class="form-input-primary"
				:class="v$.nomeCompleto.$error ? 'is-invalid' : ''" v-model="perfil.nomeCompleto" />
		...
		<div class="row mb-3">
			<div class="col-sm-8">
				...
				<input type="text" id="cpf" class="form-input-primary" :class="v$.cpf.$error ? 'is-invalid' : ''"
					v-model="perfil.cpf" />
			...
			<div class="col-sm-4">
				<label for="data-nascimento" class="form-label-primary">Data de Nascimento*</label>
				<input type="date" id="data-nascimento" class="form-input-primary"
					:class="v$.dataNascimento.$error ? 'is-invalid' : ''" v-model="perfil.dataNascimento" />
		...
		<div class="row mb-3">
			<div class="col-sm-8">
				<label for="email-corporativo" class="form-label-primary">E-mail*</label>
				<input type="email" id="email-corporativo" class="form-input-primary"
					:class="v$.email.$error ? 'is-invalid' : ''" v-model="perfil.email" />
			...
			<div class="col-sm-4">
				...
				<input type="text" id="telefone" class="form-input-primary" v-model="perfil.telefone"
		...
		<div class="mb-3">
			...
			<input type="text" id="cargo" class="form-input-primary" :class="v$.cargo.$error ? 'is-invalid' : ''"
		...
		<div class="mb-3">
			<div class="text-start">
				<label for="cep" class="form-label-primary d-inline">CEP*
					<a href="https://buscacepinter.correios.com.br/app/endereco/index.php">(Não sabe o CEP?)</a></label>
			</div>

			<input type="text" id="cep" class="form-input-primary" :class="v$.cep.$error ? 'is-invalid' : ''"
				v-model="perfil.cep" @blur="buscarCEP" />
		...
		<div class="row mb-3">
			...
			<div class="col-sm-8">
				...
				<input type="text" id="cidade" class="form-input-primary" v-model="perfil.cidade" />
			</div>
		</div>
		...
		<div class="row mb-3">
			<div class="col-sm-9">
				...
				<input type="text" id="logradouro" class="form-input-primary" v-model="perfil.logradouro" />
			</div>
			<div class="col-sm-3">
				<label for="numero" class="form-label-primary">Número*</label>
				<input type="text" id="numero" class="form-input-primary" :class="v$.numero.$error ? 'is-invalid' : ''"
		...
		<div class="mb-3">
			...
			<input type="text" id="bairro" class="form-input-primary" v-model="perfil.bairro" />
		</div>
		...
		<div class="input-icon-container mb-3">
			...
			<input :type="passwordVisibility ? 'text' : 'password'" id="password" class="form-input-primary"
				:class="v$.password.$error ? 'is-invalid' : ''" placeholder="*****" v-model="perfil.password" />
		...
		<div class="input-icon-container mb-3">
			...
			<i class="icon">
				<img :src="confirmVisibilityIconRef" class="input-icon-image" @click="changeConfirmPasswordVisibility" />
			</i>
			<input :type="confirmPasswordVisibility ? 'text' : 'password'" id="confirmPassword" class="form-input-primary"
				:class="v$.confirmPassword.$error ? 'is-invalid' : ''" placeholder="*****"
		...
		<div class="row mt-5">
			<div class="col">
				<button type="button" class="green-btn-outlined">
					VOLTAR
				</button>
			</div>

			<div class="col">
				<button type="submit" class="col green-btn-primary">
					CADASTRAR
				</button>
			</div>
		</div>
