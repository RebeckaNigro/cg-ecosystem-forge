<template>
  <form class="dark-body-text box" id="form-evento">
    ...
    <div class="nome-evento">
      ...
      <input
        type="text"
        class="form-control boring-gray-border w-100"
        id="nome-evento"
    ...
    <div class="imagem-divulgacao d-flex">
      <div>
        <label for="imagem-input-mask">Imagem de divulgação (opcional)</label>
    ...
    <div id="novo-endereco" class="novo-endereco">
      <div class="informa-endereco-ou-local">
        ...
        <input
          type="text"
          name="informa-endereco-ou-local"
          id="informa-endereco-ou-local"
          class="boring-gray-border"
    ...
    <div class="d-flex justify-content-around acoes-container">
      ...
      <button class="btn-enviar" @click.prevent="handleAction('salvar')">
        Salvar
      </button>
    </div>
  </form>
...
<script setup lang="ts">
  ...
  onMounted(async () => {
    ...
    if (props.eventoId) {
      ...
      fileName.value =
        evento.value.arquivos[0].nomeOriginal +
        "." +
        evento.value.arquivos[0].extensao
