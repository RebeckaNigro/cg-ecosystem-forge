<template>
	...
	<form class="container box p-5 mb-5" v-if="!isVisualizacao">
		...
		<div class="mb-3 text-start">
			...
			<div class="my-2 px-3">
				...
				<input type="radio" name="tipoEvento" id="tipoEventoOnline" value="2" v-model="evento.tipoEventoId" />
		...
		<div class="row mb-3">
			<div class="col-sm-6">
				...
				<div class="row px-2">
					<input type="date" id="dataInicio" class="form-input-primary col-sm-6"
						:class="v$.dataInicio.$error ? 'is-invalid' : ''" v-model="evento.dataInicio" />
					...
					<input type="time" id="horaInicio" class="form-input-primary col-sm-5"
						:class="invalidHoraInicio ? 'is-invalid' : ''" v-model="horaInicio" />
			...
			<div class="col-sm-6 mt-3 mt-md-0">
				...
				<div class="row px-2">
					<input type="date" id="dataFim" class="form-input-primary col-sm-6"
						:class="v$.dataTermino.$error ? 'is-invalid' : ''" v-model="evento.dataTermino" />
					...
					<input type="time" id="horaFim" class="form-input-primary col-sm-5"
						:class="invalidHoraFim ? 'is-invalid' : ''" v-model="horaFim" />
		...
		<div class="mb-4">
			<QuillEditor ref="customEditor" theme="snow" :toolbar="customToolbar" v-model:content="evento.descricao"
				contentType="html" />
		...
		<div class="row">
			...
			<div class="col-12 col-md-6" v-if="evento.tipoEventoId == 1">
				<!-- CEP -->
				<div class="mb-3" >
		...
		<div class="row">
			...
			<div class="mb-3" v-if="evento.tipoEventoId == 1">
				...
				<input type="text" id="logradouro" class="form-input-primary" v-model="evento.endereco.logradouro" />
			</div>

			<!-- NÚMERO -->
			<div class="mb-3" v-if="evento.tipoEventoId == 1">
				<label for="numero" class="form-label-primary">Número</label>
				<input type="text" id="numero" class="form-input-primary" v-model="evento.endereco.numero" />
			</div>

			<!-- BAIRRO -->
			<div class="mb-3" v-if="evento.tipoEventoId == 1">
				<label for="bairro" class="form-label-primary">Bairro</label>
				<input type="text" id="bairro" class="form-input-primary" v-model="evento.endereco.bairro" />
			</div>
		</div>
		...
		<div class="row mb-3" v-if="evento.tipoEventoId == 1">
			...
			<div class="col-12 col-md-6">
				...
				<input type="text" id="cidade" class="form-input-primary" v-model="evento.endereco.cidade" />
			</div>
		</div>
		...
		<div class="mb-3" v-if="evento.tipoEventoId == 1">
			...
			<input type="text" id="complemento" class="form-input-primary" v-model="evento.endereco.complemento" />
		</div>
	...
	<ConfirmModal v-show="confirmStore.visible" @confirm-true="confirmado" element-id="confirmFormModal"
		id="confirmFormModal" />
</template>
