<template>
  <form class="form-noticia boring-gray-border" @submit.prevent="handleSubmit()">
    ...
    <div class="group column-direction">
      ...
      <input type="text" id="subtitle" class="w-100 boring-gray-border" v-model="noticiaStore.novaNoticia.subTitulo">
    </div>
    <div class="labels-date">Publicado em</div>
    <div class="group row-direction align-center">
      <input type="radio" id="auto-date" class="boring-gray-border" name="data-publicacao" v-model="autoSetDate" :value="true" checked>
      <label for="auto-date">Automático</label>
    </div>  
    <div class="group row-direction align-center">
      <input type="radio" id="confirm-chosen-date" class="boring-gray-border" name="data-publicacao" v-model="autoSetDate" :value="false">
      ...
      <input type="datetime-local" name="chosen-date" id="chosen-date" class="boring-gray-border" v-model="userChosedDate">
    </div>
    <div class="group column-direction">
      <label for="main-text">Corpo do texto</label>
      <textarea name="main-text" id="main-text" cols="30" rows="10" class="w-100" v-model="noticiaStore.novaNoticia.descricao" />
    </div>
