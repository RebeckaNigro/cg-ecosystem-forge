...
export class EventoSimplificado implements IEventoSimplificado {
  ...
  constructor(
    ...
    [this.id, this.tags, this.titulo, this.dataInicio, this.dataTermino, this.local, this.arquivo] =
      arguments;
  }
}
...
export class EventoRascunho {
  ...
  constructor(evento: Evento, instituicao: Instituicao, horaInicio: string, horaTermino: string) {
    this.evento = evento;
