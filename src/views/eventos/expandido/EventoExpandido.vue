  ...
  <div class="pt-5 pb-5 container">
    ...
    <div class="evento-breadcrumb">
      <nav style="--bs-breadcrumb-divider: '>'" aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item unactive hover-pointer" @click="$router.back()">Eventos</li>
            ...
            <div class="row align-items-center">
              ...
              <div class="d-flex mt-4 mb-2 col-md-8">
                ...
                <div class="d-flex text-start align-items-center mx-2">
                  {{
                    evento.tipoEventoId == 1 ? enderecoFormatado : `Online: ${evento.linkExterno}`
                  }}
                </div>
              </div>
              <!--BOTAO-->
        ...
        <div class="row p-xl-5 p-4">
          ...
          <div class="col-lg-9">
            ...
            <div class="row mt-4 pe-lg-5 justify-content-end">
              ...
              <div class="col-md-5">
                <button
                  class="green-btn-primary text-uppercase"
...
onMounted(async () => {
  ...
  await store.getEventById(parseInt(router.currentRoute.value.params.eventoId.toString()));
...
.evento-expandido {
  ...
  .organizador-container {
    ...
    background: linear-gradient(0deg, rgba(107, 106, 100, 0.2) 0%, rgba(255, 255, 255, 0.2) 100%),
      #f8f9fa;
