    ...
    <div class="breadcrumb-container">
      <nav style="--bs-breadcrumb-divider: '>'" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li v-if="!eventoId" class="breadcrumb-item active" aria-current="page">Criar Evento</li>
          <li v-else class="breadcrumb-item active" aria-current="page">Editar Evento</li>
        </ol>
      </nav>
    </div>
