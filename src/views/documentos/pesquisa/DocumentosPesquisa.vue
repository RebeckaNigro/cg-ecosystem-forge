    ...
    >
        <div class="banner-documentos-content ghp">
            <div>
                ...
                <p class="dark-body-text" v-if="leisContainer">Leis que apoiam o desenvolvimento e inovação em Campo
                    Grande e Mato Grosso do Sul.</p>
                <p class="dark-body-text" v-if="editaisContainer">Tenha acesso aos principais editais disponibilizados
                    pelo Ecossistema Local de Inovação - Campo Grande - MS</p>
                <p class="dark-body-text" v-if="pesquisasContainer">Tenha acesso às principais pesquisas
                    disponibilizados pelo Ecossistema Local de Inovação - Campo Grande - MS</p>
            </div>
        </div>
    </Banner>
