  ...
  <div class="pt-5 pb-5 container">
    <div class="container">
      <nav style="--bs-breadcrumb-divider: '>'" aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item unactive hover-pointer" @click="$router.back()">Documentos</li>
...
onMounted(async () => {
  ...
  await documentoStore.getDocDetailsById(
    parseInt(router.currentRoute.value.params.documentoId.toString())
  );
